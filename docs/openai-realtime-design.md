...
summary: "OpenAI Realtime Voice Provider Support — technical design document"
locked: false
---

# Technical Design Document: OpenAI Realtime Voice Provider Support
...
Add one field to `envSchema`:

```
DEFAULT_VOICE_PROVIDER: z.enum(['phonic', 'openai']).default('phonic')
```
