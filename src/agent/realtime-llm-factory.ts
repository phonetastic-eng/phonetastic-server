...
export function createRealtimeLlm(
  ...
  switch (provider) {
    case 'phonic':
      ...
      return new phonic.realtime.RealtimeModel({ voice: externalId, welcomeMessage: greeting ?? 'Hi, how can I help you today?' });
    case 'openai':
    ...
    case 'xai':
      ...
      return new xai.realtime.RealtimeModel({ voice: externalId });
    default:
