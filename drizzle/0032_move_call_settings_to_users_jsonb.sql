ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "call_settings" jsonb NOT NULL DEFAULT '{}';

DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'call_settings') THEN
    UPDATE "users"
    SET "call_settings" = (
